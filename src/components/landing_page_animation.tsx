...
import { LeftUpwardsArrow, LeftUpwardsDownArrow } from '@/pattern/shared/animation/leftupwardsarrow'
...
function LandingPageAnimation() {
  return (
    <div className='flex relative w-full place-content-center'>
        ...
        <img src="/world.png" className='w-[12.063rem] m-[4.438rem] aspect-square'/>
